...
var cachify_js = exports.cachify_js = function (filename, options) {
   ...
   */
  if (options.defer ||
      (options.defer_debug && opts.production !== true) ||
      (options.defer_production && opts.production === true)) {
    link_fmt += ' defer';
  }
   ...
   */
  if (options.async ||
      (options.async_debug && opts.production !== true) ||
      (options.async_production && opts.production === true)) {
    link_fmt += ' async';
  }
